  ...
  <div>
    <nav class="bg-gray-900 px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0">
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div id="navbar-sticky" :class="{'hidden': !showMenu, 'flex': showMenu}" class="justify-between items-center w-full md:flex md:w-auto md:order-1 bg-gray-900">
